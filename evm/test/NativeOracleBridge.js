...
describe("NativeOracleBridge Contract", function () {
    ...
    describe(":: Settings", function () {
        it("Should allow owner to register an Oracle" , async function () {
            ...
            expect(await bridge.oracleExists(oracle.address)).to.equal(true);
        });
    ...
    describe(":: Request", function () {
        it("Should be created with correct parameters" , async function () {
            await expect(testerContract.makeRequest("helloworlda113", oracle.address, ["arg1", "arg2"], {"value": ONE_TLOS})).to.be.reverted;
        });
        it("Should revert if fee is incorrect" , async function () {
            await expect(testerContract.makeRequest("helloworld21", oracle.address, ["arg1", "arg2"], {"value": HALF_TLOS})).to.be.reverted;
        });
        it("Should revert if oracle is not registered" , async function () {
            await expect(testerContract.makeRequest("helloworld23", oracle2.address, ["arg1", "arg2"], {"value": ONE_TLOS})).to.be.reverted;
        });
