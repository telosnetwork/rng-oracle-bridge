...
You can find and configure the tests in the `tests` directory. By default, they run on testnet but best practice would be a local node with system contracts and oracles setup.
